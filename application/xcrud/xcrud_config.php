...
{
    // default connection
    public static $dbname = 'epiz_20375587_digitallawyer'; // Your database name
    public static $dbuser = 'epiz_20375587'; // Your database username
    public static $dbpass = 'UfMjkMR7'; // // Your database password
    public static $dbhost = 'sql310.epizy.com'; // Your database host, 'localhost' is default.
