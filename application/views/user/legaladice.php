...
<div class="w3-container" style="margin-top:10%;">
  <h3>Different types of Legal Advices</h3> 
  <div style="float:left">
  <form action="<?php echo site_url('user/home/searchlaw' ); ?>" method="post">
  <input required style="float:left" type="text" name="searchlaw" >
  <input type="submit" value="Search Advice" style="background-color: #de4949;color:white;padding: 3px;margin-left:5px;border:0px;padding:5px;">
  </form>
  </div>
